...
int main ( int argc, char * argv[] )
{
	...
	//pTvsNChargedTowardPlot->AddSystematic( vector<double>( 2, 10.0 ), vector<double>( 2, 10.0 ), 10 );
	//pTvsNChargedTowardPlot->AddSystematic( vector<double>( 2, -10.0 ), vector<double>( 2, 10.0 ), 10 );
...
/*	//Lead jet pT
	...
	//                                                        //
	////////////////////////////////////////////////////////////
	IFileInput * dataInput = mcInfo->MakeReconstructedInput( 4, relevanceChecker );
